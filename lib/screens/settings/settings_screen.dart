...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Widget _buildContent(AppEditionConfig cfg) {
    ...
    final int productColumnsPosition =
        cfg.isCloud ? (hasExtraTab ? 4 : 3) : (hasExtraTab ? 6 : 5);
    final int accessibilityPosition = productColumnsPosition + 1;
    ...
    switch (idx) {
      ...
      case 3:
        return const PdfSettingsScreenV2();
      case 4:
        return const InvoiceSettingsScreenV2();
      case 8:
  ...
  Widget build(BuildContext context) {
    ...
    if (!widget.currentUser.isAdmin()) {
      return _buildDummySection('Settings');
    }
