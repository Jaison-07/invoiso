...
class _ReportsScreenState extends ConsumerState<ReportsScreen> {
  ...
  Widget _customerModeChip(_CustomerReportMode mode, String label) {
    ...
    return ChoiceChip(
      label: Text(label),
      selected: selected,
      selectedColor: const Color(0xFF60A5FA).withValues(alpha: 0.16),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Expanded(
              flex: 2,
              child: _TableHead('Billed', right: true)),
          Expanded(
              flex: 2,
              child: _TableHead('Received', right: true)),
          Expanded(
              flex: 2,
      ...
      child: Row(
        children: [
          ...
          Expanded(
              flex: 2,
              child: Text(
                  line.billed > 0 ? _statementMoney(statement, line.billed) : '-',
                  textAlign: TextAlign.right,
                  style: TextStyle(
                      fontSize: 12,
                      color: Theme.of(context).colorScheme.onSurfaceVariant))),
          Expanded(
              ...
              child: Text(
                    line.received > 0
                      ? _statementMoney(statement, line.received)
                      : '-',
                  textAlign: TextAlign.right,
                  style:
                  ...
                  child: Row(
                    children: [
                      const Icon(Icons.event,
                          size: 16, color: Color(0xFF8AB4F8)),
                      const SizedBox(width: 6),
                      Text(
