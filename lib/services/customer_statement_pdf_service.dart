        ...
        pw.MultiPage(
          ...
          build: (context) => [
            pw.TableHelper.fromTextArray(
              headers: ['SL', 'Date', 'Type', 'Reference', 'Description', 'Billed', 'Received', 'Balance'],
              data: List<List<String>>.generate(statement.lines.length, (i) {
                ...
                return [
                  ...
                  line.reference,
                  line.description,
                  line.billed == 0 ? '' : money(line.billed),
                  line.received == 0 ? '' : money(line.received),
                  money(line.balance),
                ];
              }),
              ...
              child: pw.Row(
                ...
                children: [
                  pw.Text(
                    ...
                    'Outstanding: ${money(statement.closingBalance)}   Overdue: ${money(statement.overdueBalance)}',
                    style: pw.TextStyle(fontSize: 10, fontWeight: pw.FontWeight.bold),
                  ),
                ],
              ),
