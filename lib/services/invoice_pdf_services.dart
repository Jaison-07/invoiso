...
class InvoicePdfServices {
  ...
  /// customers without any data migration.
    static Future<String> generateNextInvoiceNumber(String type, {DateTime? date}) =>
      BackendServices.invoices.generateNextInvoiceNumber(type, date: date);
  ...
  /// Non-consuming preview of [generateNextInvoiceNumber] — for UI display only.
    static Future<String> peekNextInvoiceNumber(String type, {DateTime? date}) =>
      BackendServices.invoices.peekNextInvoiceNumber(type, date: date);
}
